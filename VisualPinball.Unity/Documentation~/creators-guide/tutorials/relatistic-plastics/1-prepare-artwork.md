...
> [!note]
> Speaking of colors, it's best to use PBR-compatibe colors, meaning your texture shouldn't contain absolute blacks or whites, and the brightness of other colors should be at around 95% max. For black, we're using `#272727` and for white `#f4f5f0`.
