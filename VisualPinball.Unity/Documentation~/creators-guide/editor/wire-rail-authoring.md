...
> [!warning]
> Wire rail authoring does not yet generate branched junctions or VPX import/export data. Drop Loop and per-wire Rail Trim are the currently available endpoint fittings.
...
- Branched junctions and endpoint fitting shapes other than Drop Loop and Rail Trim are not generated.
