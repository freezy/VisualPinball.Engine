...
namespace VisualPinball.Unity.Editor
{
	public static class FptImportEngine
	{
		...
		/// </summary>
		/// <param name="fptPath"></param>
		/// <param name="parent"></param>
		public static void Import( string fptPath, GameObject parent, bool applyPatch = true, string tableName = null)
		{
			var rootGameObj = ImportFpt(fptPath, applyPatch, tableName);
			...
			Undo.RegisterCreatedObjectUndo(rootGameObj, "Import FPT table file");

			// select imported object
			Selection.activeObject = rootGameObj;

			Logger.Info("Imported {0}", fptPath);
		}

		private static GameObject ImportFpt(string path, bool applyPatch, string tableName)
		{
			// create root object
			...
			// load table
			var table = FptTableLoader.LoadTable(path);
