// from: https://social.msdn.microsoft.com/Forums/en-US/163ef755-ff7b-4ea5-b226-bbe8ef5f4796/is-there-a-pattern-for-calling-an-async-method-synchronously?forum=async
// via: https://github.com/atteneder/glTFast/blob/openupm/Editor/Scripts/AsyncHelpers.cs
...
namespace VisualPinball.Unity.Editor
{
	internal static class AsyncHelper
	{
		...
		private class ExclusiveSynchronizationContext : SynchronizationContext
		{
			...
			private readonly AutoResetEvent m_WorkItemsWaiting = new AutoResetEvent(false);
