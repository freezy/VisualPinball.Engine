...
namespace VisualPinball.Unity.Editor
{
	...
	{
		public string Name = "Labels Library";

		public List<PinballLabelCategory> Categories = new List<PinballLabelCategory>();

		public List<PinballLabel> Labels = new List<PinballLabel>();
	}
}
