...
{
	[CustomEditor(typeof(SurfaceSideMeshComponent)), CanEditMultipleObjects]
	public class SurfaceSideMeshInspector : ItemMeshInspector<SurfaceData, SurfaceComponent, SurfaceSideMeshComponent>
	{
