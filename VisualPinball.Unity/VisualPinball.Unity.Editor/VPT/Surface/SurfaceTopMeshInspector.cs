...
{
	[CustomEditor(typeof(SurfaceTopMeshComponent)), CanEditMultipleObjects]
	public class SurfaceTopMeshInspector : ItemMeshInspector<SurfaceData, SurfaceComponent, SurfaceTopMeshComponent>
	{
