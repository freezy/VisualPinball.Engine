...
namespace VisualPinball.Unity
{
	...
	public struct Collider
	{
		...
		internal static float Contact(in ColliderHeader collHeader, ref BallState ball,
			in CollisionEventData collEvent, double hitTime, in float3 gravity, in float3 colliderVelocity)
		{
			return BallCollider.HandleStaticContact(ref ball, in collEvent, in collHeader.Material,
				(float)hitTime, in gravity, in colliderVelocity);
		}
	}
}
