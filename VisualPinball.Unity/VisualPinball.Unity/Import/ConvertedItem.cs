...
namespace VisualPinball.Unity
{
	...
	public interface IConvertedItem
	{
		...
		IEnumerable<MonoBehaviour> SetData(ItemData data, IMaterialProvider materialProvider, ITextureProvider textureProvider, Dictionary<string, IItemMainAuthoring> itemMainAuthorings);
	}
		...
		where TMainAuthoring : ItemMainAuthoring<TItem, TData>, IItemMainAuthoring
	{
		...
		public IEnumerable<MonoBehaviour> SetData(ItemData data, IMaterialProvider materialProvider, ITextureProvider textureProvider, Dictionary<string, IItemMainAuthoring> itemMainAuthorings)
		{
			if (data is TData itemData) {
				return _mainAuthoring.SetData(itemData, materialProvider, textureProvider, itemMainAuthorings);
			}
