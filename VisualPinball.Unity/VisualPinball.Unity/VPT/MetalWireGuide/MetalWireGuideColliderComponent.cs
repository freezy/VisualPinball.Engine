...
namespace VisualPinball.Unity
{
	...
	public class MetalWireGuideColliderComponent : ColliderComponent<MetalWireGuideData, MetalWireGuideComponent>
	{
		#region Data
		...
		protected override IApiColliderGenerator InstantiateColliderApi(Player player, PhysicsEngine physicsEngine)
			=> new MetalWireGuideApi(gameObject, player, physicsEngine);
	}
}
