...
{
	internal static class FlipperVelocityPhysics
	{
		internal static void UpdateVelocities(ref FlipperState state)
		{
			ref var mState = ref state.Movement;
			ref var vState = ref state.Velocity;
			ref var tricks = ref state.Tricks;
			ref var solenoid = ref state.Solenoid;
